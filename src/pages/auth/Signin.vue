        ...
        <q-form ref="form" :greedy="true">
          ...
          <q-card-section class="pt-12 pb-0 q-mb-lg">
            <p class="text-first text-dark mb-0 ">
              ...
              <router-link to="signup" style="text-decoration: none; color:#1E293B" > Don't have an account? Sign up</router-link>
          ...
          <q-card-section class="px-20 pb-20 pt-5">
            <div class="row">
              ...
              <div class="row justify-between col-12 mt-20">
  ...
  form.value.validate().then((success) => {
    if (success) {
      ...
      userStore.login({ ...model.value })
        .then((res) => {
          loading.value = false;
          //notify("Login Successfully", "positive", "check_circle");
          router.push('/');
        })
        .catch(() => {
          loading.value = false;
